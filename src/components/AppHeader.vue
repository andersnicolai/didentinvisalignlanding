  ...
  >
    <nav class="flex flex-wrap items-center justify-between px-4 sm:px-8 py-2 max-w-6xl mx-auto rounded-2xl">
      ...
      <button
        ...
        @click="openModal"
        :class="colorClass"
        class="hidden sm:block text-white font-bold py-3 px-6 rounded-full shadow-lg hover:scale-105 transition-all duration-300 ease-in-out hover:shadow-2xl focus:outline-none focus:ring-2 focus:ring-yellow-300"
      >
